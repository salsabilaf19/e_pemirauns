...
<head>
	...
	<title>E - Pemira UNS</title>
	<link rel="icon" href="dist/img/pemira.jpg">
	...
	<div class="wrapper">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item d-none d-sm-inline-block">
					<a href="index.php" class="nav-link">
						<b>Pemira UNS Berbasis Online</b>
					</a>
				</li>
			</ul>
		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<a href="index.php" class="brand-link">
				<img src="dist/img/pemira.jpg" alt="AdminLTE Logo" class="brand-image" style="opacity: .8">
				<span class="brand-text font-weight-light"> E - PEMIRA UNS</span>
			</a>
			...
			<div class="sidebar">
				...
				<nav class="mt-2">
					<ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
						...
						<li class="nav-item">
							<a onclick="return confirm('Anda yakin akan keluar?')" href="logout.php" class="nav-link">
					...
					if (isset($_GET['page'])) {
						...
						switch ($hal) {
							...
							case 'add-calon':
								...
								break;
							case 'cetak-calon':
								include "admin/calon/cetak_calon.php";
								break;
							case 'edit-calon':
							...
							case 'add-pemilih':
								...
								break;
							case 'cetak-pemilih':
								include "admin/pemilih/cetak_pemilih.php";
								break;
							case 'edit-pemilih':
							...
							case 'data-suara':
								...
								break;
							case 'cetak-suara':
								include "admin/suara/cetak_suara.php";
								break;

								//Pengguna
							case 'data-pengguna':
									include "admin/pengguna/data_suara.php";
									break;
		...
		<footer class="main-footer">
			<div class="float-right d-none d-sm-block">
				...
				<a target="_blank" href="https://www.facebook.com/radenmas.brono">
					<strong> gousky-bro </strong>
				</a>
			</div>
			Created by Salsabila F 2020
		</footer>
